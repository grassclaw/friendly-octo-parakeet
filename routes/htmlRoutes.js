...
module.exports = function(app) {
  ...
  app.get("/", function(req, res) {
    res.sendFile(path.join(__dirname, "../views/tictactoe1.html"));
  ...
  app.get("/game", function(req, res) {
    res.sendFile(path.join(__dirname, "../views/tictactoe2.html"));
  ...
  app.get("/game/:id", function(req, res) {
    res.sendFile(path.join(__dirname, "../views/tictactoe3.html"));
    // db.Example.findOne({ where: { id: req.params.id } }).then(function(titato) {
    //   res.render("example", {
    //     example: titato
    //   });
